...
# the most important part of code reviews is two-fold:
# - the obvious and most important purpose is to make sure the code works; that all modules, imports, and 
#   executions work on not only your laptop, but others as well
# - tweak code to make it more readable!  I am always looking for ways to make my code cleaner and more
#   precise, so having someone look at it and point out potential ways to conserve space, I really apprec-
#   -iate it!

# containers could help improve the situation of having people running different systems/modules on their
# screens by unifying the libraries from which they operate!  As long as people are working with the same
# software/version, they most likely will come out with the same results.
